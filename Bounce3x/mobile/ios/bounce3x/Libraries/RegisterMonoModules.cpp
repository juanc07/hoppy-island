...
extern "C"
{
	...
	extern gpointer*	mono_aot_module_JsonOrg_info; // JsonOrg.dll
	extern gpointer*	mono_aot_module_KiiCloudStorageSDK_info; // KiiCloudStorageSDK.dll
...
void RegisterMonoModules()
{
	...
	mono_aot_register_module(mono_aot_module_JsonOrg_info);
	mono_aot_register_module(mono_aot_module_KiiCloudStorageSDK_info);
